...
export default function PueblaGrowthMarketingPage() {
  ...
  const packages = [
    {
      ...
      desc: "Perfecta para validar canales y traccionar rápido sin camotearse con agencias lentas.",
    ...
    },
    {
      ...
      desc: "Para empresas medianas listas para subir como erupción de Don Goyo y dominar su sector.",
      ...
      features: [
        ...
        "Optimización SEO local (Puebla, Cholula y Nacional)",
  ...
  const coreCapabilities = [
    ...
    },
    {
      ...
      desc: "Ingeniería de medición para que sepas qué campaña atrae clientes de verdad y no te quedes como el perro de las dos tortas.",
    },
    {
      num: "03",
      title: "Asistentes de IA",
      desc: "Agentes autónomos configurados para calificar leads y agendar citas comerciales por ti mientras Don Goyo descansa.",
    },
    {
      num: "04",
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Para nada. Si vas arrancando, iniciamos con la Cápsula de Despegue. Nos enfocamos en validar tus canales principales con pautas eficientes y una landing ultra rápida. Conforme se vayan captando leads y cierres ventas en Puebla o nivel nacional, escalamos tu presupuesto y tus sistemas al siguiente nivel sin camotearnos.",
    },
    {
  ...
  return (
    <div className="relative text-white font-sans selection:bg-orangeleader/30 selection:text-white bg-transparent overflow-x-hidden w-full">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-20">
          ...
          >
            <span className="text-xs md:text-sm font-mono tracking-[0.4em] text-orangeleader uppercase block mb-6 px-4">
              SISTEMAS DE CRECIMIENTO TODO EN UNO // PUEBLA & CHOLULA
            </span>
            ...
            <h1 className="text-4xl md:text-7xl font-black uppercase leading-[1.02] tracking-tighter mb-8 max-w-4xl px-2">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orangeleader to-tangerine">
                Todo En Uno en Puebla
              </span>
            </h1>

            <p className="text-base md:text-lg text-starlight/85 max-w-2xl mx-auto leading-relaxed font-light mb-10 px-4">
              Dejemos de camotearnos con servicios sueltos. Construimos motores de crecimiento personalizados según tu presupuesto y metas de ventas: pauta digital, analítica robusta, automatización e IA operando bajo un solo sistema inteligente.
            </p>
          </motion.div>
      ...
      {/* 🚀 THE APPROACH SECTION (UN SOLO EQUIPO & CHOLULA VISUAL REFERENCE - RESPONSIVE TALLER HEIGHT MATCH) */}
      <section className="relative z-10 px-4 md:px-8 py-20 bg-transparent">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          <div className="flex flex-col justify-center">
            <Hud>Bitácora del Capitán // Puebla Digital</Hud>
            <h2 className="mt-8 text-3xl md:text-5xl font-black uppercase text-white leading-[1.05] tracking-tight">
              Un solo motor de growth en Puebla, no cinco agencias separadas
            </h2>
            <p className="mt-8 text-base text-starlight/75 leading-relaxed font-light font-sans">
              Muchas empresas contratan a una agencia para diseño web, a otra para Google Ads, a un freelance para redes sociales y a un consultor de SEO. ¿El resultado? Una nave desarticulada que gasta gasolina y se queda como el perro de las dos tortas sin saber de dónde vienen las ventas.
            </p>
          ...
          <div className="relative rounded-[40px] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(235,63,27,0.15)] w-full min-h-[300px] md:min-h-[450px] lg:min-h-full flex items-center justify-center bg-black">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/40 to-transparent p-6 text-center z-10">
              <h3 className="text-xl font-bold uppercase tracking-widest text-orangeleader">Órbita Cholula</h3>
              <p className="text-xs text-starlight/80 max-w-xs mx-auto mt-1 font-sans">
                Elevamos tu marca como el Santuario de los Remedios sobre la Gran Pirámide, con cimientos tecnológicos inquebrantables.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 🚀 DON GOGO / POPOCATÉPETL SECTION (VISUAL REFERENCE - RESPONSIVE TALLER HEIGHT MATCH) */}
      <section className="relative z-10 px-4 md:px-8 py-20 bg-transparent">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="flex flex-col justify-center lg:order-2 order-1">
            <Hud>Propulsión Don Goyo // Erupción de Prospectos</Hud>
            <h2 className="mt-8 text-3xl md:text-5xl font-black uppercase text-white leading-[1.05] tracking-tight">
              Estrategias con la fuerza activa del Popocatépetl
            </h2>
            <p className="mt-8 text-base text-starlight/75 leading-relaxed font-light font-sans">
              Nuestras campañas no van a medio gas. Inyectamos la energía del volcán activo en cada canal de adquisición digital. Configuramos flujos inteligentes automatizados que reaccionan al comportamiento del prospecto al instante, detonando una erupción constante de leads calificados directos a tu fuerza de ventas.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* 🚀 CLIENTS SECTION (MATCHING PueblaDisenoWebPage.tsx SIZING EXACTLY) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl border border-white/5 bg-white/[0.01] backdrop-blur-[2px] text-left hover:border-orangeleader/45 hover:bg-white/[0.03] hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(235,63,27,0.12)] transition-all duration-500 cursor-default">
              ...
              <p className="text-sm text-starlight/75 leading-relaxed font-light font-sans">
                Escaneamos tu funnel actual, analizamos a los competidores poblanos y modelamos la economía unitaria de tus prospectos antes de invertir el primer peso.
              </p>
            </div>
      ...
      <section id="contacto" className="relative z-10 px-4 md:px-8 py-20 bg-transparent">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="glass-liquid rounded-[40px] border border-white/10 p-6 md:p-12 relative overflow-hidden shadow-[0_20px_50px_rgba(235,63,27,0.1)] backdrop-blur-md">
            <LeadForm servicioInteres="Growth Marketing Puebla Paquetes" />
          </div>
        </div>
      </section>
